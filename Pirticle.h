...
public:
	...
	/// </summary>
	/// <returns></returns>
	static Pirticle* Create(const std::string& modelname);
...
private:
	...
	Microsoft::WRL::ComPtr<ID3D12Resource> instancingResurce_;
	TransformtMatrix* instancingData_;
