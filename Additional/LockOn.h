...
public:
	...
	void ReSearch(const std::list<std::unique_ptr<Enemy>>& enemies, const Camera& camera);

	bool IsOutOfRange(const Camera& camera);
...
private:
	...
	float kDegrreToRadian = std::numbers::pi_v<float> / 180.0f;
